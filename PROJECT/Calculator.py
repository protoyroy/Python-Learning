...
textDisplay = Entry(cal, font=('arial', 20, 'bold'), textvariable=text_Input, bd = 30 , insertwidth= 4, bg = "powderblue", justify= 'right').grid(columnspan=4)
...
Multiplication = Button(cal, padx=16,pady= 16, fg="black",font=('arial', 20, 'bold'), text ="*",bg ='powder blue', command=lambda:btnClick("*")).grid(row= 3, column =3)
...
btnClear = Button(cal, padx=16,pady= 16, fg="black",font=('arial', 20, 'bold'), text ="C",bg ='powder blue', command= btnCleaDisplay).grid(row= 4, column =1)

btnEquals = Button(cal, padx=16,pady= 16, fg="black",font=('arial', 20, 'bold'), text ="=",bg ='powder blue',command =btnEquals).grid(row= 4, column =2)
